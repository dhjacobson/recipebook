package com.dhjacobson.recipebook.activities;
...
import com.dhjacobson.recipebook.decorations.PrettyDividerItemDecoration;

import com.dhjacobson.recipebook.activities.my_recipes.MyRecipesAdapter;
import com.dhjacobson.recipebook.activities.my_recipes.RecyclerItemTouchListener;
import com.dhjacobson.recipebook.activities.recipe.RecipeActivity;
import com.dhjacobson.recipebook_commons.api.StupidDataAccessLayer;
            ...
            new RecyclerItemTouchListener.OnItemClickListener() {
                ...
                public void onItemClick(View view, int position) {
                    try {
                        ...
                        intent.putExtra("recipe", objectMapper.writeValueAsString(recipes.get(position)));
                        startActivity(intent);
                    } catch (JsonProcessingException e) {
                        Toast.makeText(getApplicationContext(), "Could not convert recipe to JSON.", Toast.LENGTH_LONG).show();
                    }
                }
